  ...
  if (date("Y-m-d", $appdate1) >= $cur_date) {
    if ((date("Y-m-d", $appdate1) == $cur_date and date("H:i:s", $apptime1) > $cur_time) or date("Y-m-d", $appdate1) > $cur_date) {
      ...
      if (mysqli_num_rows($check_query) == 0) {
        $query = mysqli_query($con, "insert into appointmenttb(pid,fname,lname,gender,email,contact,doctor,docFees,topic,appdate,apptime,acadyear,category,avail,collegename,link,userStatus,doctorStatus) values($pid,'$fname','$lname','$gender','$email','$contact','$doctor','$docFees','$topic','$appdate','$apptime','$acadyear','$category','$avail','$collegename','$link','1','1')");

        if ($query) {
          echo "<script>alert('Your have successfully registered');</script>";
        } else {
          echo "<script>alert('Unable to process your request. Please try again!');</script>";
        }
      } else {
        echo "<script>alert('Guide is busy');</script>";
      }
    } else {
...
if (isset($_GET['cancel'])) {
  ...
  if ($query) {
    echo "<script>alert('You have opted out successfully cancelled');</script>";
  }
}
...
if (isset($_GET["generate_bill"])) {
  ...
  $content .= '
      <br/>
      <h2 align ="center"> ISE Research Center </h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> ISE Research Center </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Register</a>
      <a class="list-group-item list-group-item-action" href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home">Current Status</a>
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">Progress</a>
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Register</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Current Status</h2>
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Progress</h2>
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Register</h4></center><br>
              ...
              <div class="col-md-4"><label for="doctor">Guide:</label></div>
                <div class="col-md-8">
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-8"><input type="text"  class="form-control" name="topic" id="topic" required="required"></div><br><br>
                  ...
                  <div class="col-md-4"><label>Registration Time</label></div>
                  <div class="col-md-8">
                  ...
                  <div class="col-md-8"><input type="text"  class="form-control" name="acadyear" id="acadyear" required="required"></div><br><br>
            <!-- Here the back end is not done -->
                  <div class="col-md-4">
                      ...
                      <option value="others">Others</option>
                        ...
                        <div class="col-md-4">
                          <label for="spec">Full Time/Part Time:</label>
                        </div>
                        <div class="col-md-8">
                        <select name="avail" class="form-control" id="avail" required="required">
                      ...
                      <option value="Part TIme">Part Time</option>
                        ...
                        <div class="col-md-4">
                          <label for="spec">College Name:</label>
                        </div>
                        <div class="col-md-8">
                          <select name="collegename" class="form-control" id="collegename" required="required">
                      ...
                      <option value="NITK">NITK</option>
                        ...
                        <div class="col-md-4"><label>Drive Folder Link:</label></div>
                        <div class="col-md-8"><input type="text"  class="form-control" name="link" id="link" required="required"></div><br><br>    
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query = "select ID,doctor,docFees,topic,appdate,apptime,acadyear,Category,avail,collegename,link,userStatus,doctorStatus from appointmenttb where fname ='$fname' and lname='$lname';";
                  ...
                  while ($row = mysqli_fetch_array($result)) {
                    ...
                    ?>
                                                                                                                                                        ...
                                                                                                                                                        if (($row['userStatus'] == 0) && ($row['doctorStatus'] == 1)) {
                                                                                                                                                          echo "opted out by You";
                                                                                                                                                        }

                                                                                                                                                        if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 0)) {
                                                                                                                                                          echo "Cancelled by Guide";
                                                                                                                                                        }
                                                                                                                                                        ?></td>
                                                                                                                                                            ...
                                                                                                                                                            <?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) { ?>
                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                  <a href="admin-panel.php?ID=<?php echo $row['ID'] ?>&cancel=update" 
                                                                                                                                                                                                                                                                                                      onClick="return confirm('Are you sure you want to opt out ?')"
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="func.php">
          ...
          <input type="text" name="name" placeholder="Enter Guide name" class="form-control">
          <br>
