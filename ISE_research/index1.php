...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp ISE Research Center</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="assets\images\R.V._College_of_Engineering_logo.png" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>

      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;"> RV College of Engineering</h4>
          </div>
          ...
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                ...
                <br>
              <h3 style="margin-top: 10%">Scholar Login</h3><br>
